...
a=0
r=1.3
def desenhaParaboloideCircular():     
...
window = sdl2.SDL_CreateWindow(b"Loucos Paraboloides", sdl2.SDL_WINDOWPOS_CENTERED, sdl2.SDL_WINDOWPOS_CENTERED, WINDOW_WIDTH, WINDOW_HEIGHT, sdl2.SDL_WINDOW_OPENGL | sdl2.SDL_WINDOW_SHOWN)
if not window:
